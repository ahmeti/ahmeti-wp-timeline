...
<div style="display: block;padding: 0 0 10px 0">
    <form id="form_gonder" action="<?php echo AHMETI_WP_TIMELINE_ADMIN_URL; ?>&islem=NewEventPost" method="post">
        ...
        <input type="text" id="MyDate" name="event_date" size="40"/> <?php echo _e('[ ! ] e.g.: 2010-01-30 [Year-Month-Day]','ahmeti-wp-timeline'); ?>
        <br/>
        <input type="text" name="event_time" id="EventTime" size="40" maxlength="8" /> <?php echo _e('If you want you can also add time. [ ! ] e.g.: 14:30:45 [Hour-Minute-Second]','ahmeti-wp-timeline'); ?>
        <br/><br/>
        
        <h3 style="margin-bottom: 1px;"><?php echo _e('Event Time (If Before Christ)','ahmeti-wp-timeline'); ?></h3>
        <input type="text" name="event_bc" size="40"/> <?php echo _e('[ ! ] e.g.: 2000','ahmeti-wp-timeline'); ?>
        <br/><br/>
        <br/><br/>
